...
const TestSummary = props => {
    ...
    return test.state !== 'pending' ? (react_1.default.createElement("div", { className: "columns" },
        react_1.default.createElement("div", { className: "column is-half" },
            react_1.default.createElement("table", { className: "table is-hoverable" })))):null;
                // react_1.default.createElement("tr", null,
                //     react_1.default.createElement("td", null, "Mismatch Percentage:"),
                //     react_1.default.createElement("td", null, test.misMatchPercentage)))))):null;
                //         react_1.default.createElement(TestTitle, { state: test.state }))))))):null;
