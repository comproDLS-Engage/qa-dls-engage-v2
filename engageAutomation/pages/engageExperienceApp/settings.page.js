...
module.exports = {
    ...
    checkItOut_text: selectorFile.css.ComproEngage.settings.checkItOut_text, //ENG-7484
    pageHeader_text: selectorFile.css.ComproEngage.settings.pageHeader_text  //ENG-7484
    ...
    getAccessibilityTabData: function(){
        ...
        obj = {
            ...
            checkItOut_text : action.getElementCount(this.checkItOut_text) > 0 ? action.getText(this.checkItOut_text) : null,
            pageHeader_text : action.getElementCount(this.pageHeader_text) > 0 ? action.getText(this.pageHeader_text) : null
        }
