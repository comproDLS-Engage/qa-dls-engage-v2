...
exports.config = {
    ...
    // protocol: 'http',
    //
    user: 'akankshagairola_ENYts5',
    key: '8cxTBYZUPx5P2zFsQp6E',
    ...
    services: argv.browserCapability ? [
        [TimelineService], NovusService, ['selenium-standalone', { drivers: { firefox: '0.29.1', chrome: true, chromiumedge: '91.0.864.71' } }]
    ] : argv.deviceName ? [
