...
module.exports = {
    ...
    ENG_ITEM_DNDT_TC_1: async function (testdata) {
        dndOnImageTest.ENG_ITEM_DNDI_TC_1(testdata);
    },
    ...
    ENG_ITEM_DNDT_TC_2: async function (testdata) {
        dndOnImageTest.ENG_ITEM_DNDI_TC_2(testdata);
    },
    ...
    ENG_ITEM_DNDT_TC_3: async function (testdata) {
        dndOnImageTest.ENG_ITEM_DNDI_TC_3(testdata);
    },
    ...
    ENG_ITEM_DNDT_TC_4: async function (testdata) {
        dndOnImageTest.ENG_ITEM_DNDI_TC_4(testdata);
    }
