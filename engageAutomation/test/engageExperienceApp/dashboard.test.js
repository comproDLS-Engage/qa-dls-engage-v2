...
module.exports = {
    ...
    ENG_DASH_TC_1: function (testdata) {
        ...
        // add assertion for recentlyViewed_heading
        // add assertion for exploreHeading
        // add assertion for viewAll_btn
    ...
    ENG_DASH_TC_15: function (testdata) {
        ...
        //update assestion - only non existence of book should be checked
